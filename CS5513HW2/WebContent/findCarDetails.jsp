...
<body>
	...
	<h3 align="center">Retrieve student details</h3>
	<h3 align="center"><jsp:useBean id="empsbean" class="cs5513.DataHandler" scope="session"/>
	</h3>
	<form action="findCarDetails_action.jsp">
		<div align="center"> 
      	<p>&nbsp;</p> 
      	<table cellspacing="2" cellpadding="3" border="1" width="369"> 
        <tr> 
          <td width="38%"> 
          	<strong>equipmentoption :</strong> 
          </td> 
          <td width="62%"> 
            <input type="text" name="equipmentoption"/> 
          </td> 
        </tr> 
        <tr> 
      ...
      <table cellspacing="3" cellpadding="2" border="0"> 
        <tr> 
          <td> 
            <input type="submit" value="Get car details details"/> 
          </td> 
        </tr> 
      </table> 
